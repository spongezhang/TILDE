function [erro,repeat,corresp, match_score,matches, twi]= ...
...
% we never use common_part = 0 so let's keep that as here
dimdesc1 = 0;
% dimdesc2 = 0;
common_part = 1;
...
switch lower(repeatabilityType)
...
% 		t=toc;
	...
	case 'radius'
		%tic;
		%c_eoverlap is a C implementation to compute the overlap error.
		[wout, twout, dout, ~]=c_eoverlap_RADIUS(feat1,feat2t,common_part,range);
% 		t=toc;
		erro=[10:10:60];
		corresp=zeros(1,6);
